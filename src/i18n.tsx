...
const tr = {
  ...
  'dateTracker.showAll': 'Tüm tarihleri göster',
  'dateTracker.collapseList': 'Tarih listesini daralt',
  'contacts.title': 'Kişiler',
  'contacts.add': 'Kişi Ekle',
  'contacts.sort': 'Kişi sıralaması',
  'contacts.flat': 'Düz Liste',
  'contacts.alphabetical': 'A–Z',
  'contacts.columns': 'Sütunlar',
  'contacts.nameColumn': 'Ad Soyad',
  'contacts.firstName': 'İsim',
  'contacts.lastName': 'Soyisim',
  'contacts.phone': 'Telefon No',
  'contacts.email': 'E-posta',
  'contacts.organization': 'Çalıştığı Kuruluş',
  'contacts.notes': 'Not',
  'contacts.empty': 'Henüz kişi eklenmedi.',
  'contacts.deleteNamed': '{name} kişisini sil',
  'contacts.confirmDelete': '“{name}” kişisini silmek istediğinize emin misiniz?',
  'contacts.nameRequired': 'İsim alanı gereklidir.',
  'contacts.invalidData': 'Kişi bilgilerini ve e-posta adresini kontrol edin.',
  'contacts.loadError': 'Kayıtlı kişiler yüklenemedi.',
  'contacts.saveError': 'Kişi kaydedilemedi.',
  'contacts.deleteError': 'Kişi silinemedi.',
  'contacts.hasNote': 'Bu kişinin notu var',
  'contacts.addNote': 'Kişiye not ekle',
  'contacts.editNote': 'Kişi notunu düzenle',
  'contacts.saveNote': 'Notu Kaydet',
  'contacts.copy': '{field} bilgisini kopyala',
  'contacts.copied': 'Kopyalandı',
  'contacts.copyError': 'Bilgi panoya kopyalanamadı.',
  'contacts.noteSaveError': 'Kişi notu kaydedilemedi.',
  'contacts.editContact': 'Kişi bilgilerini düzenle',
  'contacts.saveChanges': 'Değişiklikleri Kaydet',
  'contacts.updateError': 'Kişi bilgileri güncellenemedi.',
  'contacts.settings': 'Kişi ayarları',
  'contacts.exportData': 'Verileri Dışarı Aktar',
  'contacts.exported': 'Dışa aktarıldı',
  'contacts.exportError': 'Kişiler dışa aktarılamadı.',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'dateTracker.title': 'Date Tracker', 'dateTracker.eventName': 'Event name', 'dateTracker.dateFormat': 'Date format', 'dateTracker.dmy': 'DD/MM/YYYY', 'dateTracker.mdy': 'MM/DD/YYYY', 'dateTracker.indefinite': 'Indefinite', 'dateTracker.day': 'Day', 'dateTracker.month': 'Month', 'dateTracker.year': 'Year', 'dateTracker.add': 'Add Date', 'dateTracker.empty': 'No dates are being tracked yet.', 'dateTracker.dayLeft': '{count} Day Left', 'dateTracker.daysLeft': '{count} Days Left', 'dateTracker.dayElapsed': '{count} Day Elapsed', 'dateTracker.daysElapsed': '{count} Days Elapsed', 'dateTracker.today': 'Today', 'dateTracker.expired': 'Date Passed', 'dateTracker.deleteNamed': 'Delete date: {name}', 'dateTracker.confirmDelete': 'Are you sure you want to delete “{name}”?', 'dateTracker.titleRequired': 'An event name is required.', 'dateTracker.invalidDate': 'Select a valid date.', 'dateTracker.pastDate': 'A past date cannot be added.', 'dateTracker.futureStartDate': 'Select today or a past start date for an indefinite entry.', 'dateTracker.loadError': 'Saved dates could not be loaded.', 'dateTracker.saveError': 'The date could not be saved.', 'dateTracker.deleteError': 'The date could not be deleted.', 'dateTracker.showAll': 'Show all dates', 'dateTracker.collapseList': 'Collapse date list',
  'contacts.title': 'Contacts', 'contacts.add': 'Add Contact', 'contacts.sort': 'Contact sorting', 'contacts.flat': 'Flat List', 'contacts.alphabetical': 'A–Z', 'contacts.columns': 'Columns', 'contacts.nameColumn': 'Full Name', 'contacts.firstName': 'First Name', 'contacts.lastName': 'Last Name', 'contacts.phone': 'Phone No', 'contacts.email': 'Email', 'contacts.organization': 'Organization', 'contacts.notes': 'Notes', 'contacts.empty': 'No contacts have been added yet.', 'contacts.deleteNamed': 'Delete contact: {name}', 'contacts.confirmDelete': 'Are you sure you want to delete “{name}”?', 'contacts.nameRequired': 'First name is required.', 'contacts.invalidData': 'Check the contact details and email address.', 'contacts.loadError': 'Saved contacts could not be loaded.', 'contacts.saveError': 'The contact could not be saved.', 'contacts.deleteError': 'The contact could not be deleted.', 'contacts.settings': 'Contact settings', 'contacts.exportData': 'Export Data', 'contacts.exported': 'Exported', 'contacts.exportError': 'Contacts could not be exported.',
  'contacts.hasNote': 'This contact has a note', 'contacts.addNote': 'Add a note to this contact', 'contacts.editNote': "Edit this contact's note", 'contacts.saveNote': 'Save Note', 'contacts.copy': 'Copy {field}', 'contacts.copied': 'Copied', 'contacts.copyError': 'The information could not be copied to the clipboard.', 'contacts.noteSaveError': 'The contact note could not be saved.', 'contacts.editContact': 'Edit contact details', 'contacts.saveChanges': 'Save Changes', 'contacts.updateError': 'The contact details could not be updated.',
