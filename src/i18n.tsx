...
const tr = {
  ...
  'shortcuts.label': 'Dosya ve klasör kısayolları',
  ...
  'shortcuts.openError': '{name} açılamadı. Dosya veya klasör taşınmış ya da silinmiş olabilir.',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'shortcuts.title': 'Shortcuts', 'shortcuts.label': 'File and folder shortcuts', 'shortcuts.add': 'Add a shortcut to slot {slot}', 'shortcuts.folder': 'Folder', 'shortcuts.file': 'File', 'shortcuts.selectFolder': 'Select shortcut folder', 'shortcuts.selectFile': 'Select shortcut file', 'shortcuts.openNamed': 'Open {name}', 'shortcuts.removeNamed': 'Remove {name} shortcut', 'shortcuts.openError': '{name} could not be opened. The file or folder may have been moved or deleted.', 'shortcuts.selectError': 'The file or folder could not be selected.', 'shortcuts.desktopOnly': 'File and folder selection is available only in the desktop application.',
  'dateTracker.title': 'Date Tracker', 'dateTracker.eventName': 'Event name', 'dateTracker.dateFormat': 'Date format', 'dateTracker.dmy': 'DD/MM/YYYY', 'dateTracker.mdy': 'MM/DD/YYYY', 'dateTracker.day': 'Day', 'dateTracker.month': 'Month', 'dateTracker.year': 'Year', 'dateTracker.add': 'Add Date', 'dateTracker.empty': 'No dates are being tracked yet.', 'dateTracker.dayLeft': '{count} Day Left', 'dateTracker.daysLeft': '{count} Days Left', 'dateTracker.today': 'Today', 'dateTracker.expired': 'Date Passed', 'dateTracker.deleteNamed': 'Delete date: {name}', 'dateTracker.confirmDelete': 'Are you sure you want to delete “{name}”?', 'dateTracker.titleRequired': 'An event name is required.', 'dateTracker.invalidDate': 'Select a valid date.', 'dateTracker.pastDate': 'A past date cannot be added.', 'dateTracker.loadError': 'Saved dates could not be loaded.', 'dateTracker.saveError': 'The date could not be saved.', 'dateTracker.deleteError': 'The date could not be deleted.',
