# theHUB 3.1.1 Windows Installer

`theHUB-Setup-3.1.1-x64.exe` is the NSIS installer for Windows 10/11 x64. It installs the application for the current Windows account.
